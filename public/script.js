...
const translations = {
    en: {
        ...
        'warranty.products.desktops': 'Desktop Computers',
        'warranty.products.laptops': 'Laptops',
        'warranty.products.accessories': 'Accessories',
        'warranty.products.gaming': 'Gaming PCs',
    ...
    fr: {
        ...
        'warranty.products.desktops': 'Ordinateurs de Bureau',
        'warranty.products.laptops': 'Ordinateurs Portables',
        'warranty.products.accessories': 'Accessoires',
        'warranty.products.gaming': 'PC Gaming',
    ...
    ar: {
        ...
        'warranty.products.desktops': 'أجهزة الكمبيوتر المكتبية',
        'warranty.products.laptops': 'أجهزة الكمبيوتر المحمولة',
        'warranty.products.accessories': 'الملحقات',
        'warranty.products.gaming': 'أجهزة الألعاب',
