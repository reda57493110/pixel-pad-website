...
const translations = {
    en: {
        ...
        'warranty.title': '8-Month Warranty Coverage',
        ...
        'warranty.duration.title': 'Warranty Duration',
        'warranty.duration.desc': '8 months from the date of purchase',
        'warranty.duration.highlight': 'Full coverage period',
    ...
    fr: {
        ...
        'warranty.title': 'Couverture de Garantie 8 Mois',
        ...
        'warranty.duration.title': 'Durée de Garantie',
        'warranty.duration.desc': '8 mois à partir de la date d\'achat',
        'warranty.duration.highlight': 'Période de couverture complète',
    ...
    ar: {
        ...
        'warranty.title': 'تغطية الضمان 8 أشهر',
        ...
        'warranty.duration.title': 'مدة الضمان',
        'warranty.duration.desc': '8 أشهر من تاريخ الشراء',
        'warranty.duration.highlight': 'فترة تغطية كاملة',
